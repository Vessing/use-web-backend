...
public class UmlModelException extends RuntimeException {

    private final ApiErrorDto error;

    public UmlModelException(String code, String message, String userMessage, Map<String, Object> details) {
        super(message);
