...
public record UmlOperation(
    ...
    public UmlOperation(UmlOperationId id, String name, UmlType returnType, List<UmlParameter> parameters,
            String bodyExpression) {
        this(id, name, returnType, parameters, bodyExpression, UmlVisibility.PUBLIC, false, false, List.of());
    }
    ...
    public UmlOperation(UmlOperationId id, String name, UmlType returnType, List<UmlParameter> parameters) {
        this(id, name, returnType, parameters, null, UmlVisibility.PUBLIC, false, false, List.of());
    }
