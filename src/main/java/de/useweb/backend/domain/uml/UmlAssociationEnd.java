...
public record UmlAssociationEnd(
    ...
    public UmlAssociationEnd(UmlAssociationEndId id, UmlClassId classId, String roleName,
        ...
        this(id, classId, roleName, multiplicity, navigable, false, true, false, false, List.of(), List.of(), List.of(), AggregationKind.NONE);
    }
    ...
    public UmlAssociationEnd(UmlAssociationEndId id, UmlClassId classId, String roleName,
        ...
        this(id, classId, roleName, multiplicity, navigable, ordered, unique, derived, union,
                subsettedEndIds, redefinedEndIds, List.of(), AggregationKind.NONE);
    }
    ...
    public UmlAssociationEnd(UmlAssociationEndId id, UmlClassId classId, String roleName,
        ...
        this(id, classId, roleName, multiplicity, navigable, ordered, unique, derived, union,
                subsettedEndIds, redefinedEndIds, qualifiers, AggregationKind.NONE);
    }
